        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <select v-model="equipments.locations.id" class="form-control" id="locations_id" name="locations.id"
                    ...
                    <option v-for="l in locs" v-bind:value="l.id">{{l.description}}</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-3">
                <select class="form-control" id="equipmentsClassification_id" name="equipmentsClassification.id"
                    ...
                    <option v-for="c in eqClasses" v-bind:value="c.id">{{c.description}}</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-3">
                <select class="form-control" id="manageLevel" name="manageLevel" v-model="equipments.manageLevel"
                    ...
                    <option v-for="option in manageLevels " v-bind:value="option">
                        {{ option }}级设备
                    </option>
