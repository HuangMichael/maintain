...
<form class="form-horizontal" role="form" id="form">
    <fieldset class="form-group" id="a">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input class="form-control" id="productDate" type="text" name="productDate"
                       value="${equipments.productDate}"/>
            </div>
    ...
    <fieldset class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input class="form-control" id="purchasePrice" type="text" name="purchasePrice"
                       value="${equipments.purchasePrice}"/>
            </div>
            <label class="col-md-1 control-label" for="warrantyPeriod">保修期至</label>

            <div class="col-md-3">
                <input class="form-control" id="warrantyPeriod" type="text" name="warrantyPeriod"
                       value="${equipments.warrantyPeriod}"/>
            </div>
            <label class="col-md-1 control-label" for="setupDate">安装日期</label>

            <div class="col-md-3">
                <input class="form-control" id="setupDate" type="text" name="setupDate"
                       value="${equipments.setupDate}"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input class="form-control" id="expectedYear" type="text" name="expectedYear"
                       value="${equipments.expectedYear}"/>
            </div>
        </div>
    </fieldset>
